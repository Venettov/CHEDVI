        ...
        options: {
            ...
            scales: {
                ...
                x: {
                    title: {
                        display: true,
                        text: 'Overcrowded Housing Rate (%)'
                    },

                    // 👇 pushes axis slightly left so 0 values are visible
                    min: -0.8,
                    max: maxX + 1.2,
...
function createMentalHealthChart() {
    ...
    const explanations = {
        ...
        'asthma': { 
            ...
            main: 'Higher poverty rates are associated with elevated asthma rates, ranging from 19-21% in low-poverty areas to 22-26% in high-poverty communities. The bubble size (unemployment rate) reveals a compounding effect—communities with both high poverty AND high unemployment (largest bubbles) tend to cluster at higher asthma rates. However, significant scatter exists, with communities at similar poverty levels showing asthma rates varying by 4-7 percentage points.', 
            detail: 'Poverty concentrates multiple asthma triggers: substandard housing with mold and pests, proximity to highways and industrial pollution, inability to afford asthma medications or specialist care, and chronic stress that worsens inflammation. The large bubbles (high unemployment) show "total economic stress"—when poverty and joblessness combine, health outcomes deteriorate further. Financial barriers prevent both prevention (better housing) and treatment (inhalers, doctor visits).' 
        }
    };
